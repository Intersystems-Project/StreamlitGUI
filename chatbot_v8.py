...
# query: Find the total admissions each year, from 2020 - 2024, at Siloam Hospitals Lippo Village, given that its organisation id is 2

# query: What is the name of ProcedureClassificationId = 1?
# query: What is the organization id of Siloam Hospitals Lippo Village?
...
def generate_response(query, api_key, llm_choice):
    try: 
        ...
        return f"Sorry there was an error: {error_message}. Please try again."
